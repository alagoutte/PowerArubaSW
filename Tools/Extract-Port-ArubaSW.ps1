...
if (Get-Module -ListAvailable -Name PowerArubaSW) {
    ...
    Write-Output ""
    Write-Output ""
    Write-Output "    !!! THE POWERARUBASW MODULE IS NOT INSTALLING !!!"
    Write-Output ""
    Write-Output "     In order to install this module type the command"
    Write-Output "        Install-Module PowerArubaSW"
    Write-Output ""
    Write-Output "        Then restart that script again."
    Write-Output ""
    Write-Output ""
    Write-Output ""
    Write-Output "############################################################"
...
if ([string]::IsNullOrEmpty($CompanyName)) {
    ...
    Write-Output ""
    Write-Output ""
    Write-Output "        What is the name of the company?"
    Write-Output ""
    Write-Output ""
    Write-Output ""
    Write-Output "############################################################"
...
if ([string]::IsNullOrEmpty($ipswitch)) {
    ...
    Write-Output ""
    Write-Output ""
    Write-Output "         What is the IP address of the switch?"
    Write-Output ""
    Write-Output ""
    Write-Output ""
    Write-Output "############################################################"
...
Write-Output "#######################################################################"
Write-Output ""
Write-Output "       An excel file will be automatically created"
Write-Output ""
Write-Output "    It will be stored in $env:USERPROFILE\Desktop\"
Write-Output ""
Write-Output "       and will be named $($date)_$($CompanyName)_$($ipswitch).xlsx"
Write-Output ""
Write-Output "#######################################################################"
Write-Output ""
Write-Output ""
...
if ((-not [string]::IsNullOrEmpty($loginswitch)) -and (-not [string]::IsNullOrEmpty($PassSwitch))) {
    ...
    Catch {
        ...
        Write-Output ""
        Write-Output ""
        Write-Output "          !!! CAN NOT CONNECT TO SWITCH !!!"
        Write-Output ""
        Write-Output "       Check that the IP or login and password is valid."
        Write-Output ""
        Write-Output ""
        Write-Output "          Then restart that script again."
        Write-Output ""
